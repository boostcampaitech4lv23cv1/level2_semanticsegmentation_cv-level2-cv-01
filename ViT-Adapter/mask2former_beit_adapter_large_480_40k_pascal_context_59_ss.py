...
# dataset settings
img_norm_cfg = dict(
    mean=[117.3233121 , 112.09212735, 106.65954615], std=[53.7048768 , 52.9276062 , 55.16595795], to_rgb=True)
train_pipeline = [
...
evaluation = dict(interval=10000, metric='mIoU', save_best='mIoU',classwise=True,pre_eval=True)