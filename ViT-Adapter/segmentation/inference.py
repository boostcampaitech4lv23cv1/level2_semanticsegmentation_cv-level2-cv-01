...
def parse_args():
    ...
    parser.add_argument(
        "--config_path",
        type=str,
        default="./work_dirs/mask2former_beit_adapter_large_896_80k_cityscapes_ss/mask2former_beit_adapter_large_896_80k_cityscapes_ss.py",
    )
    parser.add_argument(
        "--test_images_path", type=str, default="/opt/ml/input/data/mmseg/images/test"
    )
    parser.add_argument("--iter", type=str, default="best_mIoU_iter_3000")
    parser.add_argument(
        "--work_dir",
        type=str,
        default="./work_dirs/mask2former_beit_adapter_large_896_80k_cityscapes_ss",
    )
