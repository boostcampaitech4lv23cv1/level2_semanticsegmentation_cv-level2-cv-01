...
data = dict(
    ...
    train=dict(
        ...
        img_dir='/opt/ml/input/data/mmseg/images/train',
        ann_dir='/opt/ml/input/data/mmseg/annotations/train',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
            dict(type='Resize', img_scale=(512, 512), ratio_range=(0.5, 2.0)),
    ...
    val=dict(
        ...
        type='CustomDataset',
        reduce_zero_label=False,
        img_dir='/opt/ml/input/data/mmseg/images/val',
        ann_dir='/opt/ml/input/data/mmseg/annotations/val',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
    ...
    test=dict(
        ...
        type='CustomDataset',
        reduce_zero_label=False,
        img_dir='/opt/ml/input/data/mmseg/test',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
