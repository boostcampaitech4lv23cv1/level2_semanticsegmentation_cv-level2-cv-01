...
def parse_args():
    ...
    parser.add_argument(
        "--config_path",
        type=str,
        default="/opt/ml/level2_semanticsegmentation_cv-level2-cv-01/mmsegmentation/work_dirs/upernet_convnext_xlarge_fp16_640x640_160k_ade20k/upernet_convnext_xlarge_fp16_640x640_160k_ade20k.py",
    )
    parser.add_argument(
        "--test_images_path", type=str, default="/opt/ml/input/data/mmseg/images/test"
    )
    parser.add_argument("--iter", type=str, default="best_mIoU_iter_40000")
    parser.add_argument(
        "--work_dir",
        type=str,
        default="/opt/ml/level2_semanticsegmentation_cv-level2-cv-01/mmsegmentation/work_dirs/upernet_convnext_xlarge_fp16_640x640_160k_ade20k",
    )
