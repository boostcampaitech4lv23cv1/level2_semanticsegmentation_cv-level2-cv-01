...
def main(args):
    ...
    batch01 = [os.path.join('batch_01_vt', i) for i in os.listdir(os.path.join(segclass, 'batch_01_vt'))]
    batch02 = [os.path.join('batch_02_vt', i) for i in os.listdir(os.path.join(segclass, 'batch_02_vt'))]
    batch03 = [os.path.join('batch_03', i) for i in os.listdir(os.path.join(segclass, 'batch_03'))]
    ...
    for mask_path in tbar:
        ...
        mask_filename = "copy_paste_" + '_'.join(mask_path.split('/'))
        ...
        # mask_pil.save(os.path.join(args.output_dir, 'SegmentationClass', mask_filename))
