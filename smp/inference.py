...
def parse_args():
    ...
    # model
    parser.add_argument('--model_path', type=str, default='UnetPlusPlus_xception_221220_195925')
    parser.add_argument('--metric', type=str, default='best_mIoU')              # ['best_mIoU', 'best_loss', 'latest']
...
def test(args):
    ...
    ckpt = torch.load(os.path.join(model_dir, args.metric + '.pth'), map_location=device)
    ...
    submission.to_csv(os.path.join(args.saved_dir, args.model_path+'_submission.csv'), index=False)
