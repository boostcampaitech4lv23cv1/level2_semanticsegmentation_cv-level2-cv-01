...
def parse_args():
    ...
    parser.add_argument('--base_dir', type=str, default='/opt/ml/input/level2_semanticsegmentation_cv-level2-cv-01/smp/trained_models/PAN_mit_b4_aug_221231_132545')
